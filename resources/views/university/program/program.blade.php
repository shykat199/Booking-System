@extends('layouts.app')
@section('page-title','Program List')
@push('style')
@endpush
@section('content')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6 col-12">
                    <h2>Program List</h2>
                    <button class="btn btn-primary mt-3" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm">Create New Program +</button>
                </div>
            ...
            <div class="modal-content">
                <form id="editBlogForm" method="POST" action="">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title fs-5" id="editBlogModalLabel">Update Program</h3>
                    ...
                    <div class="modal-body dark-modal">
                        ...
                        <div class="mb-3 modal-padding-space">
                            <label for="blogName" class="form-label">Duration</label>
    ...
    <div class="modal fade bd-example-modal-sm" id="mySmallCreateModalLabel" tabindex="-1" role="dialog" aria-labelledby="mySmallCreateModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body dark-modal">
                    <form id="mySmallCreateModalLabel" method="post" action="{{route('save-program')}}">
                        @csrf
                        <div class="modal-body dark-modal">
                            <div class="mb-3 modal-padding-space">
                                <label for="blogName" class="form-label">Name</label>
                            ...
                            <div class="mb-3 modal-padding-space">
                                <label for="blogName" class="form-label">Duration</label>
                                <input type="text" class="form-control" id="blogName" name="duration" required>
                            </div>
                            @error('duration') <p class="text-danger">{{$message}}</p>  @enderror
